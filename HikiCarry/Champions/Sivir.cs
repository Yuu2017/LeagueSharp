...
namespace HikiCarry.Champions
{
    internal class Sivir
    {
        ...
        public Sivir()
        {
            ...
            Obj_AI_Base.OnDoCast += SivirOnDoCast;
        ...
        private void SivirOnDoCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (args.SData.IsAutoAttack() && args.Target is Obj_AI_Hero && Initializer.Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Combo
        ...
        private void SivirOnProcess(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (sender.IsEnemy && sender is Obj_AI_Hero && Initializer.Config.Item("e.protect." + args.SData.Name, true) != null && Initializer.Config.Item("e.protect." + args.SData.Name, true).GetValue<bool>()
                && args.End.Distance(ObjectManager.Player.Position) < 200)
            {
                E.Cast();
            }

            if (sender.IsEnemy && sender is Obj_AI_Hero && args.Target.IsMe && args.Target != null &&
