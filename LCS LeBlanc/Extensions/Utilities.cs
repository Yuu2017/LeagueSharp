...
namespace LCS_LeBlanc.Extensions
{
    internal static class Utilities
    {
        ...
        public static bool HasMaliceBuff(this Obj_AI_Hero enemy) // Q DEBUFF
        {
            return enemy.HasBuff("leblancchaosorb");
        }

        public static bool HasChainBuff(this Obj_AI_Hero enemy) // E DEBUFF
        {
            return enemy.HasBuff("leblancsoulshackle");
        }

        public static bool HasSecondMaliceBuff(this Obj_AI_Hero enemy)
        {
